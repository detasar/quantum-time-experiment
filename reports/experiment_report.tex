...
passes bounded artifact inclusion:
...
hardware analyses. The artifact route is
...
\texttt{bounded\_quantum\_illustration}: the raw H502 rule passes and H503
...
proof of the basis--order--orientation theorem package. The artifact is
therefore a theory/no-go and reproducibility package with a bounded four-qubit
illustration.
