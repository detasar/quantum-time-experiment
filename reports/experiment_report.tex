...
Five checks block G4: Q303 used the deterministic fixture instead of a provider
snapshot; Q304 stopped because no real backend snapshot was available; the
preregistration template still contains mandatory TBD fields; no human approval
is recorded; and the repository is not yet clean for a preregistration tag.
